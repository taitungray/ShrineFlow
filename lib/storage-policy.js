...
export const COLLECTION_STORAGE_POLICY = Object.freeze({
  ...
  savedReplies: Object.freeze({ maxItems: 500 }),
  inboxMetadata: Object.freeze({ maxItems: 2400 }),
  notifications: Object.freeze({ maxItems: 200 }),
  errorLog: Object.freeze({ maxItems: 500 }),
  users: Object.freeze({ maxItems: 1000 }),
  memberships: Object.freeze({ maxItems: 5000 }),
  invitations: Object.freeze({ maxItems: 1000 }),
  auditEvents: Object.freeze({ maxItems: 10000 }),
});
...
export const JSON_STORAGE_POLICY = Object.freeze({
  ...
  files: Object.freeze({
    ...
    savedReplies: Object.freeze({ maxBytes: 4 * MEGABYTE }),
    ...
    users: Object.freeze({ maxBytes: 8 * MEGABYTE }),
    memberships: Object.freeze({ maxBytes: 16 * MEGABYTE }),
    invitations: Object.freeze({ maxBytes: 8 * MEGABYTE }),
    'audit-events': Object.freeze({ maxBytes: 32 * MEGABYTE }),
  }),
});
