...
export const DEFAULT_MIN_BEST_TIME_SAMPLES = 1;
export const THIN_BEST_TIME_SAMPLES = 5;
export const EXPLORATORY_BEST_TIME_SAMPLES = 10;
...
function dataQualityFor(sampleCount) {
  if (sampleCount < 1) return 'insufficient';
  if (sampleCount < THIN_BEST_TIME_SAMPLES) return 'thin';
  if (sampleCount < EXPLORATORY_BEST_TIME_SAMPLES) return 'exploratory';
  return 'adequate';
}
