...
export function createConfigRouter({ aiService, facebookPublisher, publishingPlatforms, publishingAccounts, schedulerIntervalMs, schedulerMode = 'local', repositories }) {
  const router = Router();
