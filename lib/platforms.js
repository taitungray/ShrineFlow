    ...
    contentTypes: [
      {
        ...
        name: '貼文',
        canPublish: true,
        description: '一般動態：文字、多張圖或單支影片。多圖可選輪播；圖＋影混合暫不支援。影片請用常見 mp4。',
        settings: [
    ...
    contentTypes: [
      {
        ...
        name: '貼文',
        canPublish: false,
        description: '單圖、輪播或多圖。建議清晰 JPG／PNG；有媒體需 PUBLIC_MEDIA_BASE_URL（Meta 要抓得到）。輪播請勿混入影片。',
        settings: [{ id: 'layout', name: '媒體排列', type: 'select', options: [{ value: 'single', label: '單張' }, { value: 'carousel', label: '輪播' }] }],
      },
      {
        id: 'reel',
        name: 'Reel',
