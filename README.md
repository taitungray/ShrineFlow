...
目前版本為 **v0.4.0**：內容主題已不再侷限神明，並提供響應式 App Shell、內容列表、單頁 Composer、平台預覽、日曆、素材庫、發布紀錄、平台連線與設定頁。對外產品用語統一使用「多平台」；「帳號」只保留在平台連線、憑證與 target 的技術語境。
...
5. 到內容、日曆、素材庫與發布紀錄查看後續狀態；失敗 target 可單獨重試。
